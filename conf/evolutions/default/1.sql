...
create table "order_def" ("id" int NOT NULL DEFAULT nextval('order_def_id') PRIMARY KEY, "order_id" INTEGER NOT NULL,"part_def_id" INTEGER NOT NULL,"count" INTEGER NOT NULL,"filter" VARCHAR(254) NOT NULL);
